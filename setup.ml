...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0b652a4ce5fcc9f105d00105ef800acb) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("indexed-set", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("indexed-set", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/indexed-set";
          synopsis = "OCaml implementation of indexed sets";
          description =
            Some
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/indexed-set/tree/master/src";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\135-J\179\030.\168\030\203\148 kkW\157P";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
